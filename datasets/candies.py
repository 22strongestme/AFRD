...
# dataset =
# DATASET_PATH = '../datasets/multi_lighting/all_lighting'
# DATASET_PATH = 'E:/DATASET/multi_lighting/all_lighting'
DATASET_PATH = '/autodl-fs/data/multi_lighting/all_lighting'

class CustomDataset(Dataset):
    def __init__(self, dataset_path, class_name='all_lighting', is_train=True, resize=256, cropsize=256):
